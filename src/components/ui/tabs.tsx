...
function TabsContent({ className, closeTab, ...props }: TabsContentProps) {
  return (
    <TabsPrimitive.Content
      data-slot="tabs-content"
    ...
    >
      {closeTab && (
        <button
          className="absolute cursor-pointer top-0 right-0 z-10 flex h-9 w-9 items-center justify-center rounded-full p-1 text-muted-foreground"
          onClick={() => {
            closeTab();
          }}
        >
